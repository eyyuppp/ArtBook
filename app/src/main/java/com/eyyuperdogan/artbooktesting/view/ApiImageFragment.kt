...
import com.eyyuperdogan.artbooktesting.databinding.FragmentImageApiBinding
...
class ApiImageFragment @Inject constructor(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.recyclerViewSearch.adapter=imageRecyclerAdapter
        binding.recyclerViewSearch.layoutManager=GridLayoutManager(requireContext(),3)
        imageRecyclerAdapter.setClick {
        ...
        viewModel.imageList.observe(viewLifecycleOwner, Observer {
            when(it.status) {
                Status.SUCCESS -> {
                    ...
                    fragmentBinding?.progressBarr?.visibility = View.GONE
                ...
                Status.LOADING -> {
                    fragmentBinding?.progressBarr?.visibility = View.VISIBLE
